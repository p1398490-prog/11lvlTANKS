...
const historicalData = {
  ...
  'AMX 67 Imbattable': ['Франция', '1967', 'AMX 50 / Surblindé', 'Неисторичный проект на базе AMX 50', 'В ролике индекс 67 трактуется как проект 1967 года. Для французской тяжёлой техники это уже поздний период: после 1960 года такие проекты были фактически прекращены. Машина всё же основана на AMX 50 и его варианте Surblindé с качающейся башней.'],
  'FV4025 Contriver': ['Великобритания', 'Дата не установлена', 'Прототип Centurion с 20-мм автопушкой', 'Выдуманный нерентабельный концепт', 'Проект назван выдуманным. Реальная деталь — 20-мм автопушка, которую устанавливали на прототипе Centurion, но позже отказались из-за ослабления бронирования. Разная ширина траков дополнительно делает концепт нерентабельным.'],
  ...
  'Black Rock': ['США / Великобритания', 'Дата не установлена', 'M47, «Корсар» и Concept 1B', 'Полностью выдуманный гибрид', 'В ролике Black Rock назван выдуманным проектом. Корпус выглядит как искажённый M47 или отсылка к «Корсару», а башня похожа на слегка изменённую башню проекта Concept 1B.'],
  'Объект 432У': ['СССР', '1960-е', 'Объект 432 и Т-62М', 'Собирательная советская компоновка', 'В ролике машина описана как результат «бурной ночи» между Объектом 432 и Т-62М. Клапаны на стволе названы полной выдумкой без исторического подтекста.'],
  ...
  'XM69 Hacker': ['США', 'Дата не установлена', 'XM803 / XМ1 — только визуальные отсылки', 'Полностью выдуманная башня', 'Видео называет XM69 Hacker выдуманной машиной: башня неисторична, а корпус лишь номинально напоминает KСМ1 и американские проекты.'],
  ...
  'AT-FV230 Breaker': ['Великобритания', 'Дата не установлена', 'Британские безбашенные ПТ-САУ и прототип Centurion', 'Выдуманная британская химера', 'В ролике FV230 Breaker назван странной попыткой повторить британскую идею низкопрофильной безбашенной ПТ-САУ. Реальная деталь — 20-мм автопушка, которую ставили на прототип Centurion, но затем отказались от неё из-за ослабления бронирования.'],
  ...
  'PTZ-78': ['Китай', '1978', 'WZ-113G FT', 'Ракетно-двигательная ПТ-САУ', 'Концепция противотанковой машины с последовательным ускорением.'],
  ...
  'Ares 90 C': ['Италия', '1990', 'Ares 90', 'Средний танк поддержки', 'Американский проект превращает управление нагревом автопушки в отдельный тактический ресурс.'],
  ...
  'BZT-70': ['СССР', 'Дата не установлена', '114 СП', 'Шутливый вымышленный гибрид', 'В ролике BZT-70 показан как 114 СП, который будто бы «пришибли прессом». Автор использует его как комический пример неисторичности, а не как реальный проект.'],
