...
const historicalData = {
  ...
  'BZ-79': ['Китай', 'Дата не установлена', 'КZ113 и отдельные визуальные отсылки', 'Полностью выдуманный тяжёлый танк', 'Видео прямо называет BZ-79 полностью выдуманным. Внешность смешивает башню в духе Abrams, элементы Leopard и корпус с отсылкой к KZ113, а ракетные ускорители признаны неисторичными.'],
